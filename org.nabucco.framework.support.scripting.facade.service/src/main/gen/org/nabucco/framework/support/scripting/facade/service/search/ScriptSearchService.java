 ...
 */
package org.nabucco.framework.support.scripting.facade.service.search;
...
/**
 * ScriptSearchService<p/>Service for searching scripts.<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2010-03-30
 */
public interface ScriptSearchService extends Service {
     ...
     */
    ServiceResponse<ScriptListMsg> searchScripts(ServiceRequest<ScriptSearchRq> rq) throws SearchException;
}
