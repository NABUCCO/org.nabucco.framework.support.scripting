...
/**
 * OpenScriptListViewHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class OpenScriptListViewHandlerImpl
        extends
        AbstractNabuccoOpenCorrespondingListViewHandlerImpl<ScriptListViewBrowserElement, ScriptListViewModel>
        implements OpenScriptListViewHandler {

    @Override
    public void openScriptListView() {
        run();
    }
