...
/**
 * ScriptEditViewScriptTypeContentProvider<p/>Edit view for datatype Script<p/>
 *
 * @version 1.0
 * @author Frank Ratschinski, PRODYNA AG, 2010-03-30
 */
public class ScriptEditViewScriptTypeContentProvider implements ElementPickerContentProvider {

    /** Constructs a new ScriptEditViewScriptTypeContentProvider instance. */
    public ScriptEditViewScriptTypeContentProvider() {
        super();
    }
