 ...
 */
package org.nabucco.framework.support.scripting.ui.rcp.communication.resolve;
...
public class ScriptResolveServiceDelegate extends ServiceDelegateSupport {
     ...
     */
    public ScriptMsg resolveScript(ScriptMsg message, ServiceSubContext... subContexts) throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: ScriptResolveService.resolveScript");
    }
}
