...
public class ScriptServiceDelegate extends ServiceDelegateSupport {
     ...
     */
    public ScriptExecutionResultMsg executeScript(ScriptExecutionMsg message, ServiceSubContext... subContexts)
            throws ClientException {
        ServiceRequest<ScriptExecutionMsg> request = new ServiceRequest<ScriptExecutionMsg>(
        ...
        throw new ClientException("Cannot execute service operation: ScriptService.executeScript");
    }
}
