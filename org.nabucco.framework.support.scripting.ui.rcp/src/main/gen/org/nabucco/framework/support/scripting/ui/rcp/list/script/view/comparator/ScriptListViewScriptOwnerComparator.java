...
/**
 * ScriptListViewScriptOwnerComparator
 *
 * @author Undefined
 */
public class ScriptListViewScriptOwnerComparator extends NabuccoColumComparator<Script> {

    /** Constructs a new ScriptListViewScriptOwnerComparator instance. */
    public ScriptListViewScriptOwnerComparator() {
        super();
    }
