...
/**
 * ScriptListViewScriptTypeComparator
 * 
 * @author Undefined
 */
public class ScriptListViewScriptTypeComparator extends NabuccoColumComparator<Script> {

    /** Constructs a new ScriptListViewScriptTypeComparator instance. */
    public ScriptListViewScriptTypeComparator() {
        super();
    }
