...
/**
 * ScriptListViewTableFilter<p/>ListView for Scripts<p/>
 *
 * @author Frank Ratschinski, PRODYNA AG, 2010-03-29
 */
public class ScriptListViewTableFilter extends NabuccoTableFilter {

    /** Constructs a new ScriptListViewTableFilter instance. */
    public ScriptListViewTableFilter() {
        super();
    }
    ...
    public boolean select(final Viewer viewer, final Object parentElement, final Object element) {
        ...
        if (((null == searchFilter.getFilter()) || (0 == searchFilter.getFilter().length()))) {
            ...
            Script datatype = ((Script) element);
            ...
            result = (result || this.contains(datatype.getType(), searchFilter.getFilter()));
